<template>
  <div class="israeliHome">
    ...
    <div class="POI">
      <img class="imgMap" src="../assets/home.png" />
    </div>
    <p class="location1">
      {{ $t("MuseumMotto") }}
    </p>
